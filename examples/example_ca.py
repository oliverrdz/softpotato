...
plt.figure()
plt.step(time_array, potential_array, where="post", color="#2ca02c", linewidth=2, label="CA Potential Step")

plt.title("Chronoamperometry (CA) Applied Potential Profile", fontsize=12, fontweight="bold")
