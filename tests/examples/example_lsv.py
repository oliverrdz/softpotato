...
plt.figure()
plt.plot(time_array, potential_array, color="#1f77b4", linewidth=2, label="LSV Waveform")

plt.title("Linear Sweep Voltammetry (LSV) Applied Potential Profile", fontsize=12, fontweight="bold")
